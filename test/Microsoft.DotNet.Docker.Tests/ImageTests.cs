...
namespace Microsoft.DotNet.Docker.Tests
{
    public class ImageTests
    {
        ...
        private static readonly ImageData[] s_linuxTestData =
        {
            ...
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.BusterSlim, SdkOsVariant = OS.Buster },
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.Bionic },
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.Alpine37 },
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.AlpineEdge },
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.StretchSlim, SdkOsVariant = OS.Stretch, Architecture = "arm" },
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.BusterSlim, SdkOsVariant = OS.Buster, Architecture = "arm" },
            ...
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.BusterSlim, SdkOsVariant = OS.Buster, IsWeb = true },
            ...
            new ImageData { DotNetVersion = "2.1", OsVariant = OS.AlpineEdge, IsWeb = true },
